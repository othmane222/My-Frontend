  ...
  return (
    ...
    >
      <div className="container d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
        <div className="card p-5" style={{ width: '100%', maxWidth: '500px' }}>
          <h2 className="text-center mb-4" style={{ color: '#445E75', fontWeight: 'bold' }}>
            Search Flights
          </h2>
          ...
          <div className="mt-4">
            {flights.length > 0 ? (
              flights.map((flight, index) => (
                <div key={flight.idFlight} className="flight-card mb-3 p-3 shadow-sm bg-light rounded">
